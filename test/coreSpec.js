...
describe("Testing application of core functions", function () {
  it("Domain 'example.com' in core should be return property 'domain' and 'origin' equals 'example'", function () {
    var parsedHost = core.parseHost('example.com');
  ...
  it("When domain equals 'example' and origin equals 'aws', target should be 'http://aws.amazon.com:80'", function () {
